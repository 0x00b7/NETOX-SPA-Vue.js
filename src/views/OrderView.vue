    ...
    methods: {
        btn(event) {
            if (event.target.id === 'next-btn') {
                // Validation Logic...
                const formElements = [this.form.forename, this.form.surname, this.form.email];
                ...
                for (let i = 0; i < formElements.length; i++) {
                    ...
                    if (this.step === 4 && this.form.imagination.length < 12) {
                        x = true;
                        document.getElementById('description').style.border = "1px solid orange";
                    }
                }
                if (x) return;
                // NEXT
      ...
      <div class="section">
         ...
         <div class="order-now">
            ...
            <div class="input" v-show="step === 4">
               <div class="interface">
                  <div class="order-input">
                     <label class="textarea">Description <span>*</span>
         ...
         <div class="button" v-if="step === 2 || step === 3 || step === 4 || step === 5">
            <button v-if="step === 5" class="next" @click="handleSubmit">Send</button>
            <button v-else-if="step" id="next-btn" class="next" @click="btn">Next</button>
...
.order-input label {
	background: -webkit-linear-gradient(70deg, rgba(60, 90, 250, 0.7) 0%, rgba(250, 70, 150, 0.7) 100%);
	background: -moz-linear-gradient(70deg, rgba(60, 90, 250, 0.7) 0%, rgba(250, 70, 150, 0.7) 100%);
	background: -o-linear-gradient(70deg, rgba(60, 90, 250, 0.7) 0%, rgba(250, 70, 150, 0.7) 100%);
