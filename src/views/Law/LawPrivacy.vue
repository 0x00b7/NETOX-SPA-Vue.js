<template>
  <div class=privacy>
     ...
     Zif. 7 DS-GVO ist:<br />
     <br /> <p style="font-weight: 600;">NETOX</p>Gernot Lehle<br />Einsteinstraße 1<br />59174, Kamen<br />E-Mail-Adresse:
     admin@netox.ws<br /><br /><strong>Datenarten, Zwecke der Verarbeitung und
     ...
     <strong>1. Arten der Daten, die wir verarbeiten</strong><br
        />Nutzungsdaten (Zugriffszeiten, besuchte Websites etc.), Kontaktdaten
     (Telefonnummer, E-Mail, Fax etc.), Zahlungsdaten (Bankdaten, Kontodaten,
     Zahlungshistorie etc.), Inhaltsdaten (Texteingaben, Videos, Fotos etc.),
     Kommunikationsdaten (IP-Adresse etc.), <br />
     <br />
     <strong>2. Zwecke der Verarbeitung nach Art. 13 Abs. 1 c)
     DS-GVO</strong><br />Website technisch und wirtschaftlich optimieren, Leichten
     Zugang zur Website ermöglichen, Nutzererfahrung verbessern, Marketing / Vertrieb
     / Werbung, Erstellung von Statistiken, Kundenservice und Kundenpflege,
     Kontaktanfragen abwickeln, <br />
     <br />
     <strong>3. Kategorien der betroffenen Personen nach Art. 13 Abs. 1 e)
     DS-GVO</strong><br />Besucher/Nutzer der Website, Kunden, Interessenten, <br />
     <br />
     ...
     <ol style="margin:10px 0px; padding:15px;">
        ...
        <li>Wir speichern aus Sicherheitsgründen diese Daten in
           Server-Logfiles für die Speicherdauer von 180 Tagen. Nach Ablauf dieser Frist
     ...
     <ol style="margin:10px 0px; padding:15px;">
        <li><strong>Widerspruch oder Widerruf gegen die Verarbeitung Ihrer
           ...
           können Sie uns unter folgenden Kontaktdaten informieren:<br /><br />NETOX<br
              />Einsteinstraße 1<br />59174, Kamen<br />E-Mail-Adresse: admin@netox.ws<br
              /></strong>
           <br />
        </li>
     ...
     <br />
     <br/>
     <strong>Stand: 28.12.2022</strong>
  </div>
</template>
