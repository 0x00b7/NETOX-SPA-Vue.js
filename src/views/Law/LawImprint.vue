<template>
    <div class=imprint>
       ...
       <p style="font-weight: 600;">NETOX</p>
       <p>Gernot Lehle
          <br />Einsteinstraße 1<br/>59174 Kamen
       </p><br>
       <p>Telefon: 015257826751<br />
          E-Mail: <a href="mailto:admin@netox.ws">admin@netox.ws</a><br />
       </p>
       <br />
       <h2>Hinweis gem&auml;&szlig;
          Online-Streitbeilegungs-Verordnung
       </h2>
       <p>Nach geltendem Recht sind wir
          ...
          zu finden: <a href="http://ec.europa.eu/odr" target="_blank"
             ...
             href="mailto:admin@netox.ws">admin@netox.ws</a>
       </p>
       <p>Wir weisen aber darauf
          hin, dass wir nicht bereit sind, uns am Streitbeilegungsverfahren im Rahmen der
          Europ&auml;ischen Online-Streitbeilegungs-Plattform zu beteiligen. Nutzen Sie
          zur Kontaktaufnahme bitte unsere obige E-Mail und Telefonnummer.
       </p>
       <br /><br
          />
