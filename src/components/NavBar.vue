...
.mobile-nav {
  background: -webkit-linear-gradient(45deg, rgba(22,32,82,1) 0%, rgba(70,22,31,1) 100%);
  background: -moz-linear-gradient(45deg, rgba(22,32,82,1) 0%, rgba(70,22,31,1) 100%);
  background: -o-linear-gradient(45deg, rgba(22,32,82,1) 0%, rgba(70,22,31,1) 100%);
